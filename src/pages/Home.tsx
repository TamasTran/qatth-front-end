  ...
  return (
    <div className="space-y-14">
      <section className="relative overflow-hidden rounded-3xl border border-transparent p-10 md:p-16 bg-[linear-gradient(-30deg,#1A1F2B_0%,#2C3E50_50%,#5C6E75_100%)] shadow-lg">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
          <motion.div
            ...
            className="space-y-5"
          >
          <img src="/logo.png" alt="QATTH" className="h-auto w-20 object-contain drop-shadow-lg"/>
      ...
      <section className="text-center">
        <h2 className="text-2xl font-semibold mb-3">Sẵn sàng bắt đầu?</h2>
        <p className="text-slate-300 mb-6">Đăng nhập để trải nghiệm đầy đủ tính năng của QATTH.</p>
